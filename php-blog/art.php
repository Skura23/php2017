...
//查询文章
$sql = "select title,subtitle,content,pubtime,comm,art_id,pic,cat.catname,cat.cat_id from art inner join cat on art.cat_id=cat.cat_id where art.art_id=$art_id";
$art = mGetRow($sql);

//var_dump($art['content']);exit();
